...
import { getBinary, modifyFirmware, uploadFirmware, validateFirmware } from './firmware';
...
export default class FirmwareUpdate extends AbstractMethod<'firmwareUpdate', Params> {
    ...
    async run() {
        ...
        return validateFirmware(device.features.major_version, binary, randombytes(32));
    }
}
