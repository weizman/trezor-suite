...
export { DevicePromptModal } from './ReduxModal/DeviceContextModal/DevicePromptModal';

export type { DevicePromptModalProps } from './ReduxModal/DeviceContextModal/DevicePromptModal';
