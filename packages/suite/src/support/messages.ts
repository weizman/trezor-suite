...
const definedMessages = defineMessages({
    ...
    TR_EXCHANGE_TOKENS_NOT_TRANSFERABLE_AFTER_ALL_BALANCE_EXCHANGE: {
        defaultMessage:
            'You will not be able to move your tokens if you exchange all your {symbol}.',
        id: 'TR_EXCHANGE_TOKENS_NOT_TRANSFERABLE_AFTER_ALL_BALANCE_EXCHANGE',
    },
    TR_EXCHANGE_RECEIVING_ADDRESS_HAS_ZERO_BALANCE: {
        defaultMessage:
            'Receiving address has 0 {symbol}.{lineBreak}You need a balance to be able to move your tokens.',
    ...
    TR_SELL_TOKENS_NOT_TRANSFERABLE_AFTER_ALL_BALANCE_SELL: {
        defaultMessage: 'You will not be able to move your tokens if you sell all your {symbol}.',
